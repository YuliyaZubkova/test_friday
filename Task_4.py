...
if revenue > costs:
    ...
    stuff_number = int(input("Введите численность сотрудников фирмы: "))
    print("Прибыль фирмы в расчете на одного сотрудника =", profit / stuff_number)
else:
    print ("Финансовый результат - убыток. Его величина:", costs - revenue)